...
function AddBand()
{
  ...
  function GUI_ADD_SLIDER( name, a, b, fn )
  {
    ...
    GUI_ADD_SLIDER("period",10,200,RebuildAndRedraw);
    ...
    GUI_ADD_SLIDER("strokeWeight",0,5,RebuildAndRedraw);
    GUI_ADD_SLIDER("strokeWeightVar",0,2,RebuildAndRedraw);
...
function RecolorWaves()
{
  for(var i=0;i<g_waves.length;i++)
  {
    g_waves[i].InitColor(params);
  }
}
*/
